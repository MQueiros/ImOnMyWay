...
public class ShowLocations extends FragmentActivity implements
		LocationListener, OnMapReadyCallback, ConnectionCallbacks,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!isGooglePlayServicesAvailable()) {
			Toast.makeText(ShowLocations.this,
	...
	public void onMapReady(GoogleMap map) {
		...
		for (int i = 0; i < locationsList.size(); i++) {
			...
			map.addMarker(new MarkerOptions().title(locStruct.getName())
