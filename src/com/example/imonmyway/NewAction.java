...
public class NewAction extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTitle(getResources().getString(R.string.new_action_bar_title));

		action_types = new String[]{ getResources().getString(R.string.action_type_message), getResources().getString(R.string.action_type_call) };
		...
		type.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(NewAction.this,
						ActionTypesActivity.class);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == PICK_CONTACT) {
			if (resultCode == Activity.RESULT_OK) {
				...
				// Form an array specifying which columns to return, you can add
				// more.
		...
		if (new_action.getContactList() != null
				&& new_action.getLocation() != null) {
