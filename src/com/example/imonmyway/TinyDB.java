...
public class TinyDB {
    ...
    public ArrayList<LocationsStruct> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson(); 
    	
    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<LocationsStruct> objects =  new ArrayList<LocationsStruct>();
    	
    	for(String jObjString : objStrings){
    		LocationsStruct value  = (LocationsStruct) gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public ArrayList<ActionsStruct> getListObjectActions(String key, Class<?> mClass){
    	Gson gson = new Gson(); 
    	
    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<ActionsStruct> objects =  new ArrayList<ActionsStruct>();
    	
    	for(String jObjString : objStrings){
    		ActionsStruct value  = (ActionsStruct) gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<LocationsStruct> locationsList){
    	checkForNullKey(key); 
    	Gson gson = new Gson(); 
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(LocationsStruct obj : locationsList){
    		objStrings.add(gson.toJson(obj));
    	}
    	putListString(key, objStrings);
    }
    
    public void putListObjectActions(String key, ArrayList<ActionsStruct> actionsList){
    	checkForNullKey(key); 
    	Gson gson = new Gson(); 
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(ActionsStruct obj : actionsList){
    		objStrings.add(gson.toJson(obj));
    	}
    	putListString(key, objStrings);
    }
