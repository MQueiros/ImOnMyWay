...
public class TinyDB {
	...
	public ArrayList<LocationsStruct> getListObject(String key, Class<?> mClass) {
		...
		for (String jObjString : objStrings) {
			LocationsStruct value = (LocationsStruct) gson.fromJson(jObjString,
					mClass);
			objects.add(value);
		}
		return objects;
	...
	public ArrayList<ActionsStruct> getListObjectActions(String key,
			Class<?> mClass) {
		Gson gson = new Gson();
		...
		for (String jObjString : objStrings) {
			ActionsStruct value = (ActionsStruct) gson.fromJson(jObjString,
					mClass);
			objects.add(value);
		}
		return objects;
	...
	public void putListObject(String key,
			ArrayList<LocationsStruct> locationsList) {
		checkForNullKey(key);
		Gson gson = new Gson();
	...
	public void putListObjectActions(String key,
			ArrayList<ActionsStruct> actionsList) {
		checkForNullKey(key);
		Gson gson = new Gson();
		ArrayList<String> objStrings = new ArrayList<String>();
