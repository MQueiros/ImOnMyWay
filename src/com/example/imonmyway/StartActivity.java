...
public class StartActivity extends ActionBarActivity {
	...
	private void updateDisplay(TextView edit) {
		edit.setText(new StringBuilder().append(pad(pHour)).append(":")
				.append(pad(pMinute)));
	}
	...
	private void displayToast() {
		Toast.makeText(
				this,
				new StringBuilder().append("New end time chosen: ").append(
						clock_edit.getText()), Toast.LENGTH_SHORT).show();
		...
		start.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (actionsRunningList.size() == 0) {
					Toast.makeText(
							StartActivity.this,
							getResources().getString(R.string.start_no_actions),
				...
				tinydb.putString("RunningEndTime", clock_edit.getText()
						.toString());

				startService(new Intent(StartActivity.this,
						BackgroundActionsService.class));

				Intent openRunActivity = new Intent(
